                ...
                <x-admin::form :action="route('admin.session.store')">
                    ...
                    <div class="px-4 pb-4">
                        <div class="relative flex items-center justify-center my-2">
                            ...
                            <span class="absolute bg-white dark:bg-gray-900 px-2 text-[10px] font-semibold text-gray-400 uppercase tracking-wider">OR</span>
                        </div>

                        <a
                            href="{{ route('admin.auth.socialite.redirect', 'google') }}"
                            class="flex w-full items-center justify-center gap-2.5 rounded-lg border border-gray-300 bg-white py-2 px-3 text-xs font-bold text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-750 transition"
                        >
